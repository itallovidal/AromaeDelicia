        ...
        <main id={'wrapper'}>
            ...
            <Section.wrapper idName={'container_mistura'}>
                ...
                <div id={'wrapper_itens'}>
                    {misturaItens.map((item, i)=> <MisturaItem key={i} src={item.src} text={item.text}/>)}
                </div>
            ...
            <Section.wrapper  idName={'container_tiposCafe'}>
                ...
                <div id={'wrapper_types'}>
                    {cafeTypes.map((item, i)=> <CafeType  key={i} src={item.src} cafeType={item.type} text={item.text}/>)}
                </div>
            ...
            <Section.wrapper idName={'container_restaurantes'}>
                {restaurantes.map((item, i)=> <Restaurante key={i} src={item.src} name={item.name} text={item.text}/>)}
            </Section.wrapper>
        </main>
    );
}
